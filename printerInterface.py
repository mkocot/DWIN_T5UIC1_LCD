...
class PrinterData:
    ...
    def init_Webservices(self):
        ...
        self.SHORT_BUILD_VERSION = self.getREST(
            '/machine/update/status?refresh=false')['result']['version_info']['klipper']['version']

        data = self.getREST(
            '/printer/objects/query?toolhead')['result']['status']
    ...
    def openAndPrintFile(self, filenum):
        ...
        self.postREST('/printer/print/start',
